...
- **TypeScript Strict Mode:** We embrace strong typing. Avoid using `any` wherever possible. If you must bypass the compiler, use `@ts-expect-error` with a comment explaining _why_.
...
_Example: `feat: add warning threshold to auto-mod engine`_
